      ...
      <nav className="fixed z-20 flex flex-wrap w-screen items-center justify-between px-2 py-1 top-0 bg-white fill-black mb-3 border border-2 border-b-gray-200 ">
          ...
          >
            <ul className="flex flex-col lg:flex-row list-none lg:ml-auto">
              ...
              <li className="nav-item" onClick={() => setAkunOpen(!akunOpen)}>
                <p className="px-3 py-2 flex items-center text-sm md:text-lg font-normal leading-snug text-black hover:opacity-75 cursor-pointer">
        ...
        {akunOpen ? (
          <div className="container ">
            <div className="justify-items-center bg-white border border-2 border-gray-200 fixed   md:right-10 h-40 min-h-fit z-50 grid grid-cols-2 max-w-sm h-40 rounded-xl">
              <button onClick={handleLogout}>
                <div className="w-20 h-26 mx-2 mt-5 mb-2 text-center">
                  <img src={defaultPhoto} className="rounded rounded-full " />
                  <p className="cursor-pointer mt-4 hover:text-gray-400 mb-10">
                    Log Out
                  </p>
                </div>
              </button>
